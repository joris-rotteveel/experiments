...
const textureUtils = window.textureUtils;
...
function drawScene(time) {
  ...
  setUniforms(programInfo, uniformsThatAreTheSameForAllObjects);
  ...
  objects.forEach(function (object) {
    ...
    setUniforms(programInfo, object.materialUniforms);
